...
fluid_part.set_from_numpy(fluid_part.pos, cube_gen.np_pos)
fluid_part.set_val(fluid_part.mass, pushed_num[None],
...
cube_gen.generate_pos_based_on_span(span=g_part_size[None])
pushed_num = val_i(cube_gen.num)
bound_part.set_from_numpy(bound_part.pos, cube_gen.np_pos)
bound_part.set_val(bound_part.mass, pushed_num[None],
